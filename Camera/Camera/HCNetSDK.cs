...
public class CHCNetSDK
{
    ...
    **********************************************************/
    //可以写明绝对路径。
    //如果不写路径，则需将其复制到system32目录
    //[DllImport("E:\\尾气检测\\asp.net\\bin\\HCNetSDK.dll")]
    ...
    **********************************************************/
    ...
    [DllImport("HCNetSDK.dll")]
    public static extern bool NET_DVR_ResetLens(long lUserId,long lChannel);

    [DllImport("HCNetSDK.dll")]
    public static extern bool NET_DVR_FocusOnePush(long lUserId, long lChannel);
